          ...
          <View style={[s.card, { marginBottom: 12 }]}>
            ...
            !started ? (
              ...
              <View>
                ...
                {readingTab==='ot' && <View style={{ backgroundColor: '#f8f9fa', borderRadius: 10, padding: 14 }}><Text style={{ fontSize: 13, fontWeight: '700', color: C.teal, marginBottom: 4 }}>Old Testament</Text><Text style={{ fontSize: 15, fontWeight: '800', color: C.navy, marginBottom: 8 }}>{todayReading.ot_reference}</Text><Text style={{ fontSize: 15, color: '#1a1a1a', lineHeight: 25 }}>"{todayReading.ot_text}"</Text></View>}
                {readingTab==='nt' && <View style={{ backgroundColor: '#f8f9fa', borderRadius: 10, padding: 14 }}><Text style={{ fontSize: 13, fontWeight: '700', color: C.teal, marginBottom: 4 }}>New Testament</Text><Text style={{ fontSize: 15, fontWeight: '800', color: C.navy, marginBottom: 8 }}>{todayReading.nt_reference}</Text><Text style={{ fontSize: 15, color: '#1a1a1a', lineHeight: 25 }}>"{todayReading.nt_text}"</Text></View>}
                {readingTab==='psalm' && <View style={{ backgroundColor: '#f8f9fa', borderRadius: 10, padding: 14 }}><Text style={{ fontSize: 13, fontWeight: '700', color: C.teal, marginBottom: 4 }}>Psalm</Text><Text style={{ fontSize: 15, fontWeight: '800', color: C.navy, marginBottom: 8 }}>{todayReading.psalm_reference}</Text><Text style={{ fontSize: 15, color: '#1a1a1a', lineHeight: 25 }}>"{todayReading.psalm_text}"</Text></View>}
                {readingTab==='proverb' && <View style={{ backgroundColor: '#f8f9fa', borderRadius: 10, padding: 14 }}><Text style={{ fontSize: 13, fontWeight: '700', color: C.teal, marginBottom: 4 }}>Proverbs</Text><Text style={{ fontSize: 15, fontWeight: '800', color: C.navy, marginBottom: 8 }}>{todayReading.proverbs_reference}</Text><Text style={{ fontSize: 15, color: '#1a1a1a', lineHeight: 25 }}>"{todayReading.proverbs_text}"</Text></View>}
